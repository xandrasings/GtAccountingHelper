...
AMAZON_SUMMARY_DATA = [BEGINNING_BALANCE_SUBTOTAL, ORDERS_SUBTOTAL, REFUNDS_SUBTOTAL, SHIPPING_SERVICES_SUBTOTAL, TOTAL_BALANCE, UNAVAILABLE_BALANCE, TRANSFER_AMOUNT]